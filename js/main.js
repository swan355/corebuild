$(document).ready(function () {
    ...
    window.Picker = function (e, t) {
        function n(r, i, o, a) {
            ...
            var u = {
            ...
            }, l = o ? $.extend(!0, {}, o.defaults, a) : a || {}, d = $.extend({}, n.klasses(), l.klass), m = $(r), p = function () {
                return this.start();
            }, h = p.prototype = {
                constructor: p,
                $node: m,
                start: function () {
                    return u && u.start ? h : (u.methods = {}, u.start = !0, u.open = !1, u.type = r.type, r.autofocus = r == document.activeElement, r.type = "text", r.readOnly = !0, h.component = new o(h, l), h.$root = $(n._.node("div", s(), d.picker)).on({
                        ...
                        click: function (e) {
                            ...
                            t != h.$root.children()[0] && (e.stopPropagation(), h.$root.find(document.activeElement).length || r.focus(), o.nav && !i.hasClass(d.navDisabled) ? h.set("highlight", h.component.item.highlight, {
                                nav: o.nav
                            }) : n._.isInteger(o.pick) && !i.hasClass(d.disabled) ? h.set({
                                select: o.pick,
                                highlight: o.pick
                ...
                set: function (e, t, r) {
                    ...
                    if (e) {
                        a || (s[e] = t);
                        for (i in s)
                            o = s[i], h.component.item[i] && h.component.set(i, o, r || {}), ("select" == i || "clear" == i) && m.val("clear" == i ? "" : n._.trigger(h.component.formats.toString, h.component, [l.format, h.component.get(i)])).trigger("change");
                        h.render();
                    }
                ...
                on: function (e, t) {
                    ...
                    if (e) {
                        o || (a[e] = t);
                        for (r in a)
                            i = a[r], u.methods[r] = u.methods[r] || [], u.methods[r].push(i);
                    }
                    return h;
                },
        ...
        return n.klasses = function (e) {
            ...
            group: function (e) {
                for (var t, r = "", i = n._.trigger(e.min, e); n._.trigger(e.max, e, [i]) >= i; i += e.i)
                    t = n._.trigger(e.item, e, [i]), r += n._.node(e.node, t[0], t[1], t[2]);
                return r;
            },
    ...
    (function () {
        function e(e, t) {
            ...
            i.settings = t, i.queue = {
                ...
                37: -1,
                go: function (e) {
                    i.set("highlight", [i.item.highlight.year, i.item.highlight.month, i.item.highlight.date + e], {
                        interval: e
                    }), this.render();
                }
        ...
        e.prototype.set = function (e, t, i) {
            ...
            var i = this;
            return t ? Picker._.isInteger(t) && (t = i.now(e, t, {
                rel: t
            })) : t = "min" == e ? -1 / 0 : 1 / 0, t;
            ...
            var r = this, n = {};
            if (!t || Picker._.isInteger(t) || Array.isArray(t) || Picker._.isDate(t) || Picker._.isObject(t) && Picker._.isInteger(t.pick))
                return t;
            if (!i || !i.format)
     ...
     * date picker
     */
    var $inputDate = $('#input_date').pickadate(), picker = $inputDate.pickadate('picker'), $inputText = $('#input_text').on({
        change: function () {
