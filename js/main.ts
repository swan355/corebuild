...
(function() {
  ...
  e.prototype.set = function(e, t, i) {
    ...
    return r.formats.toArray(i.format).map(function(e) {
      var i = r.formats[e],
        a = i ? Picker._.trigger(i, r, [t, n]) : e.replace(/^!/, "").length;
    ...
    var r = this,
      ...
      y = function() {
        var e = l.year,
          t = n.selectYears === !0 ? 5 : ~~(n.selectYears / 2);
        if (t) {
          var i = u.year,
            r = d.year,
            a = e - t,
